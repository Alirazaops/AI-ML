...
dataset=pd.read_csv(r"/Users/ali/github/AI-ML/ML/MLR/House_data.csv")
...
filename = '/Users/ali/github/AI-ML/ML/MLR/MLR_Housing_model.pkl'
with open(filename, 'wb') as file:
    pickle.dump(model, file)
print("Model has been pickled and saved as MLR_Housing_model.pkl")
